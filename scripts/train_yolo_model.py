#!/usr/bin/env python3
"""
Train YOLO Model for DentalAI with Real Data

This script trains a YOLO model for the DentalAI iOS app using real dental data.
The model detects actual dental conditions from real images.

Usage:
    python train_yolo_model.py --data /path/to/dental/dataset --output dental_model.pt
"""
...
Examples:
    ...
    python train_yolo_model.py --data /path/to/dental/dataset --output dental_model.pt --epochs 100
    
    # Use pretrained model for testing (no training)
    python train_yolo_model.py --output pretrained_model.pt --pretrained
    
    # Train with different model size
    python train_yolo_model.py --data /path/to/dental/dataset --output dental_model.pt --model_size s
        """
    )
